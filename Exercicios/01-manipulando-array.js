/**
  **Manipulando um array**
  ...
  Utilize uma função nativa para fazer as respectivas alterações no array 'filmes':

  - Insira o objeto novoFilme no array filmes;
...
const novoFilme = { nome: 'IT - CAPÍTULO 2', anoLancamento: 2019, gênero: 'Terror' };
